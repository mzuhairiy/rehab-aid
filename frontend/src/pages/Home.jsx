              ...
              <div>
                <div className="lg:w-[570px]">
                  ...
                  <p className="text__para">
                    ...
                    ullamco laboris nisi ut aliquip consequat quadra.
                  </p>
      ...
      <section>
        ...
        lg:mt-[55px]"
          >
            ...
            <div className="py-[30px] px-5 flex flex-col items-center text-center">
              <div className="flex items-center justify-center">
                <img src={icon02} alt="Find a Doctor" />
              </div>
            ...
            <div className="py-[30px] px-5 flex flex-col items-center text-center">
              <div className="flex items-center justify-center">
                <img src={icon03} alt="Find a Doctor" />
              </div>
            ...
            <div className="relative z-10 xl:w-[770px] flex justify-end mt-[50px] lg:mt-0">
              ...
              >
                <div className="flex items-center justify-between">
                  ...
                  <span
                    className="w-5 h-5 lg:2-[34px] lg:h-[34px] flex items-center justify-center
